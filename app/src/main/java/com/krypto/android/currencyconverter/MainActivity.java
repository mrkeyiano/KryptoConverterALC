package com.krypto.android.currencyconverter;
...
import com.krypto.android.currencyconverter.Adapter.CardListAdapter;
import com.krypto.android.currencyconverter.Data.CardContract;
import com.krypto.android.currencyconverter.Data.CardDbHelper;
import com.krypto.android.currencyconverter.Dialog.ConversionDialog;
import com.krypto.android.currencyconverter.Dialog.NoInternet;
import com.krypto.android.currencyconverter.Model.Card;
...
//        });
        ...
        cardListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                builder.setMessage("Remove Card ?");
    ...
    public void onClick(View v) {
        ...
        switch (id){
            ...
            case R.id.fab3:
                ...
                Toast.makeText(this, "Click and Hold the card to Remove", Toast.LENGTH_LONG).show();
                break;
        }
    }
...
//    initialize FABs
    ...
    public void add_card () {
        ...
        ImageButton cancel = (ImageButton) addDialog.findViewById(R.id.cancel);
